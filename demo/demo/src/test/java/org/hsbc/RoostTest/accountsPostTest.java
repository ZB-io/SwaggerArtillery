// ********RoostGPT********
/*
Test generated by RoostGPT for test rest-assured-ui-insights-test using AI Type Open AI and AI Model gpt-4
...
public class accountsPostTest {
	...
	public void setUp() {
		...
		String[] envVarsList = { "" };
		envList = dataloader.load("src/test/java/org/hsbc/RoostTest/accountsPostTest.csv", envVarsList);
	}
    ...
    public void accountsPost_Test() throws JSONException {
      ...
      switch(Integer.toString(responseObj.statusCode()).charAt(0)){
              ...
              if (contentType.contains("application/xml") || contentType.contains("text/xml")) {
                ...
                if(stringifiedStatusCode == "201"){					System.out.println("Description: successful operation");
				}
